...
function showDossierDetail(id) {
  ...
  detail.innerHTML = `
    ...
    <button onclick="purchaseProduct('full_report')" style="background:#fff;color:#1e3a5f;padding:10px 20px;border:2px solid #1e3a5f;border-radius:8px;margin-top:8px;margin-left:8px;cursor:pointer;font-size:12px;">📋 Laporan Lengkap (10 Pi)</button>
